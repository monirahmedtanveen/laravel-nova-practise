...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return Nova.request().get('/nova-vendor/fastpay/editprofile');
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 11:
                                ...
                                this.$toasted.show(this.__('There was a problem submitting the form'), { type: 'error' });
        ...
        createRequest: function createRequest() {
            return Nova.request().post('/nova-vendor/fastpay/editprofile', this.fields);
        }
    }
});
              ...
              [
                ...
                _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                  _c("input", {
                    ...
                    class: _vm.errors && _vm.errors.name ? "border-danger" : "",
                    attrs: {
                      id: "name",
                      name: "name",
                      dusk: "name",
                ...
                _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                  _c("input", {
                    ...
                    staticClass:
                      "w-full form-control form-input form-input-bordered",
                    class:
                      _vm.errors && _vm.errors.email ? "border-danger" : "",
                    attrs: {
                      id: "email",
                      name: "email",
                      dusk: "email",
              ...
              _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                _c(
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.fields.user_type,
                        expression: "fields.user_type"
                      }
                    ],
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm._l(_vm.fields.user_types, function(u_type) {
                      return _c("option", [_vm._v(_vm._s(u_type))])
                    })
                  ],
                  2
                ),
                ...
                _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                  _c("input", {
                    ...
                    staticClass:
                      "w-full form-control form-input form-input-bordered",
                    class:
                      _vm.errors && _vm.errors.password ? "border-danger" : "",
                    attrs: {
                      id: "password",
                      name: "password",
                      dusk: "password",
