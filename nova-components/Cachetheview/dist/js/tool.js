...
/* harmony default export */ __webpack_exports__["default"] = ({
    methods: {
        activateCache: function activateCache() {
            alert("Success THE SHIT");
            Nova.request().post('/nova-vendor/cachetheview/').then(function (data) {
                alert("Successfully cache the view");
            });
        }
    }
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Cache The View")]),
      _vm._v(" "),
      _c(
        "card",
        {
